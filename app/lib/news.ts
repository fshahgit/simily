...
export const ALL_NEWS: NewsDay[] = [
  {
    ...
    items: [
    {
      ...
      title: "OpenAI Begins GPT-5 Enterprise Rollout After Six-Month Testing Phase",
      summary: "OpenAI has started deploying GPT-5 to enterprise customers following an extended safety evaluation period. The model demonstrates significant improvements in reasoning, code generation, and multimodal understanding. Microsoft Azure customers will receive priority access as part of their expanded partnership agreement.",
      category: "AI",
      publisher: "Reuters",
    ...
    },
    {
      ...
      title: "Apple Announces Vision Pro 2 at WWDC 2026 with 40% Weight Reduction",
      summary: "Apple unveiled the second-generation Vision Pro headset at WWDC 2026, featuring a significantly lighter design at 380 grams and improved battery life of 4 hours. The device includes a new M4 chip and enhanced hand tracking. Pricing starts at $2,999, with shipping expected in September.",
      category: "Gadgets",
      publisher: "The Verge",
    ...
    },
    {
      ...
      title: "Ethereum's Pectra Upgrade Goes Live, Enabling Account Abstraction",
      summary: "The Ethereum network successfully activated the Pectra upgrade, introducing EIP-7702 which brings native account abstraction to the blockchain. This allows regular wallets to function like smart contracts, enabling gasless transactions and improved security features. The upgrade passed without major incidents across all major clients.",
      category: "Blockchain",
      publisher: "CoinDesk",
      sourceUrl: "https://coindesk.com/ethereum-pectra-upgrade-account-abstraction",
      image: "https://images.unsplash.com/photo-1559526324-593bc073d938?w=800&auto=format&q=80",
      date: "2026-06-17",
      readTime: 3,
    },
    {
      id: "google-quantum-computing-milestone",
      title: "Google Quantum AI Achieves 1,000 Logical Qubit Milestone",
      summary: "Google's Quantum AI division announced it has successfully operated a quantum computer with 1,000 logical qubits with error correction. This represents a major step toward practical quantum computing applications. The team used their Willow chip architecture to demonstrate sustained quantum calculations for over 10 minutes.",
      category: "Science",
      publisher: "Wired",
      sourceUrl: "https://wired.com/google-quantum-1000-logical-qubits",
    ...
    },
    {
      ...
      title: "Meta's Threads Surpasses 500 Million Monthly Active Users",
      summary: "Meta reported that Threads has reached 500 million monthly active users, cementing its position as a major social platform. The growth was driven by recent ActivityPub federation features allowing interaction with Mastodon users. Meta plans to introduce creator monetization tools in Q3 2026.",
      category: "Tech",
      publisher: "TechCrunch",
      sourceUrl: "https://techcrunch.com/meta-threads-500-million-users-2026",
    ...
    },
    {
      ...
      title: "NVIDIA Previews Rubin GPU Architecture for 2027 AI Data Centers",
      summary: "NVIDIA provided technical details on its upcoming Rubin architecture at a developer conference, promising 3x performance gains over Blackwell for AI training workloads. The architecture will use HBM4 memory and a new NVLink interconnect supporting 256 GPU clusters. Major cloud providers have already placed advance orders.",
      category: "Tech",
      publisher: "Ars Technica",
      sourceUrl: "https://arstechnica.com/nvidia-rubin-architecture-2027-preview",
      image: "https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=800&auto=format&q=80",
      date: "2026-06-17",
      readTime: 5,
    },
    ],
