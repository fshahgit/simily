    ...
    <div className="mx-auto max-w-4xl px-4 py-12 space-y-8">
      ...
      <div className="relative">
        ...
        <input
          ...
          autoFocus
          className="w-full rounded-2xl border border-slate-300 bg-white py-4 pl-12 pr-4 text-slate-900 placeholder-slate-400 outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-500/20 transition-all text-base shadow-sm"
        />
        {query && (
          <button
            onClick={() => setQuery("")}
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {bestTopics.map((topic) => (
              <Link
                ...
                className="group flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-sm transition-all hover:border-violet-300 hover:shadow-md hover:bg-slate-50"
              >
