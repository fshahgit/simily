        ...
        {related.map(({ a: ra, b: rb }) => {
          ...
          return (
            <Link
              ...
              className="flex items-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-sm transition-all hover:border-violet-300 hover:bg-slate-50 hover:shadow-md group"
            >
              <LogoAvatar name={ra} size={28} />
              <div className="flex flex-col min-w-0">
                <span className="text-xs font-semibold text-slate-800 truncate group-hover:text-violet-600 transition-colors">
                  {ra} vs {rb}
                </span>
